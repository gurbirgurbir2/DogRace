...
namespace DogRace
{
    ...
    public class Jhon : Punter // Inherit from the Punter class
    {
        public Jhon() // Sets up the punter Jhon
        {
            Name = "Jhon da don";
            Cash = 50;
        }
    ...
    public class Patlu : Punter // Inherit from the Punter class
    {
        public Patlu() // Sets up the punter Patlu
        {
            Name = "Patlu";
            Cash = 50;
        }
